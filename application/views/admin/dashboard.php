...
<html lang="en">
   <head>
      ...
      <!-- Data Tables -->
      <link href="<?php echo base_url(); ?>admin_assets/css/dataTables.bootstrap.css" rel="stylesheet">
      <link href="<?php echo base_url(); ?>admin_assets/css/responsive.bootstrap.css" rel="stylesheet">
      <!-- Custom Theme Style -->
      <link href="<?php echo base_url(); ?>admin_assets/css/a.css" rel="stylesheet">
      <style media="screen">
      .card {
   ...
   <body class="nav-md">
      <div class="container body">
         <div class="main_container">
            ...
            <!-- footer content -->
            <footer>
               <div class="pull-right"><font color="black"><b>
                 CV TM OPTICAL 2019</b></font>
               </div>
