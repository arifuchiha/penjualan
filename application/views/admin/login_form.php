...
<html lang="en">
   <head>
      ...
      <title>Login Form</title>
       <link rel="shortcut icon" href="tm.png"/>
   ...
   <body>
      <div class="container">
         <center>
            <span class="header"><img src="tm.png" width="50" height="50"> CV TMoptical</span>
         </center>
         <div class="col-md-4 col-sm-12 col-md-offset-4">
            ...
            <p style="color:black">Lupa dengan password anda ? Silahkan klik <a href="<?= base_url(); ?>lost_admin">disini</a></p>
         </div>
      </div>
      <!-- jQuery -->
